		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#entmetadatapockptmetadatacockpit-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"entmetadatapockptmetadatacockpit-display": {
								"semanticObject": "entmetadatapockptmetadatacockpit",
								"action": "display",
								"description": "A Fiori application for metadata.",
								"title": "Metadata Cockpit",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ent.metadata.pockpt.metadatacockpit",
									"url": sap.ui.require.toUrl("ent/metadata/pockpt/metadatacockpit")
								}
							}
						}
					}
